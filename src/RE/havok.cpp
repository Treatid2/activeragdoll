...
const hkQuadReal g_vectorConstants[HK_QUADREAL_END] = {
    ...
    HK_QUADREAL_CONSTANT(0.00392156886f, 0.00392156886f, 0.00392156886f, 0.00392156886f),
    ...
    HK_QUADREAL_CONSTANT(3.40282002e+38f, 3.40282002e+38f, 3.40282002e+38f, 3.40282002e+38f),
    ...
    HK_QUADREAL_CONSTANT(1.00390625f, 1.00390625f, 1.00390625f, 1.00390625f),
    HK_QUADREAL_CONSTANT(1.96608e+9f, 1.96608e+9f, 1.96608e+9f, 1.96608e+9f),
    HK_QUADREAL_CONSTANT(5.08626308e-10f, 5.08626308e-10f, 5.08626308e-10f, 5.08626308e-10f)
};
