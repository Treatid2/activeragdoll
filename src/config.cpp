...
namespace Config {
    ...
    bool ReadConfigOptions()
    {
        ...
        if (!RegisterFloat("grabbedActorMovementNoStrafeLateralStartAngle", options.grabbedActorMovementNoStrafeLateralStartAngle)) success = false;
        ...
        if (!RegisterFloat("grabbedActorMovementRagdollOffsetInfluence", options.grabbedActorMovementRagdollOffsetInfluence)) success = false;
        ...
        if (!RegisterFloat("grabbedActorMovementMinPlayerMoveAmtToForceTranslation", options.grabbedActorMovementMinPlayerMoveAmtToForceTranslation)) success = false;
